...
zad2Frame::zad2Frame(wxWindow* parent,wxWindowID id)
{
    ...
    StaticText2 = new wxStaticText(this, ID_STATICTEXT2, _("ODEJMOWANIE :"), wxPoint(24,200), wxDefaultSize, 0, _T("ID_STATICTEXT2"));
    ...
    Connect(ID_TEXTCTRL1,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&zad2Frame::OnTextCtrl2Text);
    Connect(ID_TEXTCTRL2,wxEVT_COMMAND_TEXT_UPDATED,(wxObjectEventFunction)&zad2Frame::OnTextCtrl2Text);
...
void zad2Frame::OnButton1Click(wxCommandEvent& event)
{
    ...
    wxString wiadomosc_oblicz = "Wyniki:";
    wxMessageBox(wiadomosc_oblicz, _("Obliczenia sa nastepujace"));
}
...
void zad2Frame::OnTextCtrl2Text(wxCommandEvent& event)
{
    double z=0;
    if(TextCtrl2->GetValue().ToDouble((&z))==0){
         wxString wiadomosc = "Wpisujesz wartosc:)";
        wxMessageBox(wiadomosc, _("KOMUNIKAT"));
    }
}
