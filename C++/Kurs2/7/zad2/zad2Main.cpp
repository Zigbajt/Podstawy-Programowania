...
//(*IdInit(zad2Dialog)
const long zad2Dialog::ID_STATICTEXT1 = wxNewId();
const long zad2Dialog::ID_BUTTON1 = wxNewId();
const long zad2Dialog::ID_STATICLINE1 = wxNewId();
const long zad2Dialog::ID_BUTTON2 = wxNewId();
//*)

BEGIN_EVENT_TABLE(zad2Dialog,wxDialog)
    //(*EventTable(zad2Dialog)
    //*)
END_EVENT_TABLE()

zad2Dialog::zad2Dialog(wxWindow* parent,wxWindowID id)
{
    //(*Initialize(zad2Dialog)
    ...
    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&zad2Dialog::OnAbout);
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&zad2Dialog::OnQuit);
    //*)
}

zad2Dialog::~zad2Dialog()
{
    //(*Destroy(zad2Dialog)
    //*)
}

void zad2Dialog::OnQuit(wxCommandEvent& event)
{
    Close();
}

void zad2Dialog::OnAbout(wxCommandEvent& event)
{
